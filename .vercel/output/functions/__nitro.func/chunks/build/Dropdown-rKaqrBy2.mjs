import { _ as _export_sfc, a as __nuxt_component_0$6, e as __nuxt_component_1$1, z as __nuxt_component_1, B as mergeConfig, C as useUI, I as s$4, F as twMerge, X as getNuxtLinkProps, S as arrow, G as appConfig, i as i$5, j as o$1, A as A$2, l as l$2, k as i$1, N as N$3, w as w$2, x as w$4, y as h, t as t$2, m as u$5, W as _, r as o, U as v$1, V as N$4, O as O$1 } from './server.mjs';
import { defineComponent, resolveComponent, mergeProps, withCtx, renderSlot, createVNode, resolveDynamicComponent, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, Fragment, renderList, Transition, toRef, computed, ref, watch, useId, onMounted, onUnmounted, watchEffect, nextTick, provide, inject, useSSRContext } from 'vue';
...
import { u as usePopper, p, a as u$1, i, c, f } from './usePopper-DZihrI_3.mjs';
...
let ge = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(o$12, { slots: M, attrs: i2 }) {
  ...
  return w$2([p2, e], (t2, a) => {
    var n;
    l2.closeMenu(), w$4(a, h.Loose) || (t2.preventDefault(), (n = o$1(p2)) == null || n.focus());
  }, computed(() => I.value === 0)), provide(A, l2), t$2(computed(() => u$5(I.value, { [0]: i$1.Open, [1]: i$1.Closed }))), () => {
    let t2 = { open: I.value === 0, close: l2.closeMenu };
    return A$2({ ourProps: {}, theirProps: o$12, slot: t2, slots: M, attrs: i2, name: "Menu" });
  };
  ...
  var b;
  let p2 = (b = o$2.id) != null ? b : `headlessui-menu-button-${i$5()}`, e = O("MenuButton");
  ...
  return () => {
    ...
    return A$2({ ourProps: a, theirProps: t2, slot: l2, attrs: M, slots: i$12, name: "MenuButton" });
  };
  ...
  var l$1;
  let p2 = (l$1 = o$2.id) != null ? l$1 : `headlessui-menu-items-${i$5()}`, e = O("MenuItems"), r = ref(null);
  ...
  function f2(t2) {
    ...
    switch (r.value && clearTimeout(r.value), t2.key) {
      ...
      case o.Escape:
        ...
        break;
      case o.Tab:
        t2.preventDefault(), t2.stopPropagation(), e.closeMenu(), nextTick(() => v$1(o$1(e.buttonRef), t2.shiftKey ? N$4.Previous : N$4.Next));
        break;
      default:
  ...
  let g = l$2(), b = computed(() => g !== null ? (g.value & i$1.Open) === i$1.Open : e.menuState.value === 0);
  return () => {
    var s2, v2;
    ...
    return A$2({ ourProps: n, theirProps: a, slot: t2, attrs: M, slots: i$3, features: N$3.RenderStrategy | N$3.Static, visible: b.value, name: "MenuItems" });
  };
  ...
  return () => {
    ...
    return A$2({ ourProps: { id: p$1, ref: r, role: "menuitem", tabIndex: u2 === true ? void 0 : -1, "aria-disabled": u2 === true ? true : void 0, onClick: b, onFocus: l2, onPointerenter: a, onMouseenter: a, onPointermove: n, onMousemove: n, onPointerleave: s2, onMouseleave: s2 }, theirProps: { ...i$12, ...h2 }, slot: C, attrs: i$12, slots: M, name: "MenuItem" });
  };
} });
...
const _sfc_main = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const NuxtLink = __nuxt_component_0$6;
    s$4(() => useId());
    return {
      // eslint-disable-next-line vue/no-dupe-keys
      ui,
...
//# sourceMappingURL=Dropdown-rKaqrBy2.mjs.map
