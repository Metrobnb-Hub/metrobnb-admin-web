import { _ as _export_sfc, e as __nuxt_component_1$1, B as mergeConfig, C as useUI, F as twMerge, I as s$4, G as appConfig, i as i$5, j as o$1, A as A$2, p as f$1, E as E$2, q as u$3, T as T$1, r as o, Z as k } from './server.mjs';
import { defineComponent, resolveComponent, mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, toRef, computed, useId, inject, ref, onMounted, watch, h, Fragment, onUnmounted, unref, provide, useSSRContext } from 'vue';
...
defineComponent({ name: "Label", props: { as: { type: [Object, String], default: "label" }, passive: { type: [Boolean], default: false }, id: { type: String, default: null } }, setup(t, { slots: n, attrs: i$1 }) {
  var r;
  let e = (r = t.id) != null ? r : `headlessui-label-${i$5()}`, o2 = d();
  return onMounted(() => onUnmounted(o2.register(e))), () => {
    ...
    return f2 && (delete u2.onClick, delete u2.htmlFor, delete s2.onClick), A$2({ ourProps: u2, theirProps: s2, slot: p2, attrs: i$1, slots: n, name: l });
  };
} });
...
defineComponent({ name: "SwitchGroup", props: { as: { type: [Object, String], default: "template" } }, setup(l, { slots: c, attrs: i2 }) {
  ...
  return provide(C, { switchRef: r, labelledby: f2, describedby: p2 }), () => A$2({ theirProps: l, ourProps: {}, slot: {}, slots: c, attrs: i2, name: "SwitchGroup" });
} });
let ue = defineComponent({ name: "Switch", emits: { "update:modelValue": (l) => true }, props: { as: { type: [Object, String], default: "button" }, modelValue: { type: Boolean, default: void 0 }, defaultChecked: { type: Boolean, optional: true }, form: { type: String, optional: true }, name: { type: String, optional: true }, value: { type: String, optional: true }, id: { type: String, default: null }, disabled: { type: Boolean, default: false }, tabIndex: { type: Number, default: 0 } }, inheritAttrs: false, setup(l, { emit: c, attrs: i$1, slots: r, expose: f$1$1 }) {
  var h$1;
  let p$1 = (h$1 = l.id) != null ? h$1 : `headlessui-switch-${i$5()}`, n = inject(C, null), [t, s$12] = d$1(computed(() => l.modelValue), (e) => c("update:modelValue", e), computed(() => l.defaultChecked));
  function m() {
    s$12(!t.value);
  }
  ...
  return onMounted(() => {
    ...
    let { name: e, value: a2, form: K, tabIndex: y, ...b } = l, T$1$1 = { checked: t.value }, B = { id: p$1, ref: o$2, role: "switch", type: L.value, tabIndex: y === -1 ? 0 : y, "aria-checked": t.value, "aria-labelledby": n == null ? void 0 : n.labelledby.value, "aria-describedby": n == null ? void 0 : n.describedby.value, onClick: D, onKeyup: R, onKeypress: x };
    return h(Fragment, [e != null && t.value != null ? h(f$1, E$2({ features: u$3.Hidden, as: "input", type: "checkbox", hidden: true, readOnly: true, checked: t.value, form: K, disabled: b.disabled, name: e, value: a2 })) : null, A$2({ ourProps: B, theirProps: { ...i$1, ...T$1(b, ["modelValue", "defaultChecked"]) }, slot: T$1$1, attrs: i$1, slots: r, name: "Switch" })]);
  };
} });
...
//# sourceMappingURL=Toggle-DLYZoy61.mjs.map
