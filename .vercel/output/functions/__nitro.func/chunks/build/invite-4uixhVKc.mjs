import { L as __nuxt_component_2, _ as _export_sfc, f as __nuxt_component_0$2, e as __nuxt_component_1$1, z as __nuxt_component_1, B as mergeConfig, C as useUI, D as useInjectButtonGroup, F as twMerge, G as appConfig, H as get, I as s$4, J as select, K as selectMenu, i as i$5, m as u$5, j as o$1, A as A$2, l as l$2, k as i$1, N as N$3, w as w$2, x as w$4, y as h, t as t$2, p as f$1, E as E$2, q as u$3, T as T$1, h as i$3, r as o, s as t$1, o as o$3, v as n$2, O } from './server.mjs';
import { _ as __nuxt_component_4$1 } from './FormGroup-jqZJ_kV3.mjs';
import { _ as __nuxt_component_6 } from './Input-CkIGuQjB.mjs';
import { _ as __nuxt_component_5 } from './Select-C-fTWFr4.mjs';
import { defineComponent, ref, withAsyncContext, watch, computed, mergeProps, withCtx, unref, createVNode, createTextVNode, withModifiers, createBlock, createCommentVNode, openBlock, toDisplayString, resolveComponent, resolveDynamicComponent, renderSlot, Fragment, renderList, Transition, toRef, toRaw, useId, onMounted, onUnmounted, watchEffect, nextTick, provide, h as h$1, inject, cloneVNode, reactive, useSSRContext } from 'vue';
import { useVirtualizer } from '@tanstack/vue-virtual';
import { d, e } from './form-DsUILy5F.mjs';
import { s } from './use-resolve-button-type-CgmJ7gVL.mjs';
import { u as usePopper, p, c, a as u$1, i as i$2, f } from './usePopper-DZihrI_3.mjs';
import { computedAsync, useDebounceFn } from '@vueuse/core';
import { j as defu, y as isEqual } from '../nitro/nitro.mjs';
import { twJoin } from 'tailwind-merge';
import { u as useFormGroup } from './useFormGroup-B3564yef.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderVNode, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderSlot, ssrRenderList, ssrRenderStyle } from 'vue/server-renderer';
...
let ie = Symbol("VirtualContext"), Ae$1 = defineComponent({ name: "VirtualProvider", setup(a, { slots: h$12 }) {
  ...
  return watch([u2], () => {
    e2.value += 1;
  }), provide(ie, r.virtual.value ? o2 : null), () => [h$1("div", { style: { position: "relative", width: "100%", height: `${o2.value.getTotalSize()}px` }, ref: (c2) => {
    if (c2) {
  ...
  let M = computed(() => a.multiple ? 1 : 0), $2 = computed(() => a.nullable), [B, p2] = d(computed(() => a.modelValue), (t2) => y("update:modelValue", t2), computed(() => a.defaultValue)), R = computed(() => B.value === void 0 ? u$5(M.value, { [1]: [], [0]: void 0 }) : B.value), V = null, i2 = null;
  function I(t2) {
  ...
  }, defaultValue: computed(() => a.defaultValue), nullable: $2, immediate: computed(() => false), virtual: computed(() => null), inputRef: e$1, labelRef: u2, buttonRef: c$1, optionsRef: f$2, disabled: computed(() => a.disabled), options: v, change(t2) {
    p2(t2);
  ...
  w$2([e$1, c$1, f$2], () => l2.closeCombobox(), computed(() => o2.value === 0)), provide(ne, l2), t$2(computed(() => u$5(o2.value, { [0]: i$1.Open, [1]: i$1.Closed })));
  let g2 = computed(() => {
    var t2;
  ...
  return onMounted(() => {
    ...
    return h$1(Fragment, [...t2 != null && R.value != null ? e({ [t2]: R.value }).map(([q, ue]) => h$1(f$1, E$2({ features: u$3.Hidden, key: q, as: "input", type: "hidden", hidden: true, readOnly: true, form: s2, disabled: n2, name: q, value: ue }))) : [], A$2({ theirProps: { ...r, ...T$1(b, ["by", "defaultValue", "immediate", "modelValue", "multiple", "nullable", "onUpdate:modelValue", "virtual"]) }, ourProps: {}, slot: O2, slots: h$12, attrs: r, name: "Combobox" })]);
  };
} });
defineComponent({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r }) {
  ...
  return () => {
    ...
    return A$2({ ourProps: S, theirProps: f2, slot: c2, attrs: h2, slots: r, name: "ComboboxLabel" });
  };
} });
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r, expose: y }) {
  ...
  return () => {
    ...
    return A$2({ ourProps: D, theirProps: d2, slot: v, attrs: h2, slots: r, name: "ComboboxButton" });
  };
  ...
  var V;
  let u2 = (V = a.id) != null ? V : `headlessui-combobox-input-${i$5()}`, e2 = K("ComboboxInput"), c$1 = computed(() => i$3(o$1(e2.inputRef))), f2 = { value: false };
  ...
  function p2(i2) {
    var T2, l2, g2;
    let I = (T2 = i2.relatedTarget) != null ? T2 : t$1.find((t2) => t2 !== i2.currentTarget);
    (l2 = o$1(e2.buttonRef)) != null && l2.contains(I) || (g2 = o$1(e2.optionsRef)) != null && g2.contains(I) || e2.disabled.value || e2.immediate.value && e2.comboboxState.value !== 0 && (e2.openCombobox(), o$3().nextFrame(() => {
  ...
  i$2({ container: computed(() => o$1(o2.optionsRef)), enabled: computed(() => o2.comboboxState.value === 0), accept(S) {
  ...
  return () => {
    var D, E2, w2;
    let S = { open: o2.comboboxState.value === 0 }, v = { "aria-labelledby": (w2 = (D = o$1(o2.labelRef)) == null ? void 0 : D.id) != null ? w2 : (E2 = o$1(o2.buttonRef)) == null ? void 0 : E2.id, id: u2, ref: o2.optionsRef, role: "listbox", "aria-multiselectable": o2.mode.value === 1 ? true : void 0, onMousedown: f2 }, d2 = T$1(a, ["hold"]);
    return A$2({ ourProps: v, theirProps: d2, slot: S, attrs: h$12, slots: o2.virtual.value && o2.comboboxState.value === 0 ? { ...r, default: () => [h$1(Ae$1, {}, r.default)] } : r, features: N$3.RenderStrategy | N$3.Static, visible: c2.value, name: "ComboboxOptions" });
  };
  ...
  let o2 = K("ComboboxOption"), u$12 = `headlessui-combobox-option-${i$5()}`, e2 = ref(null), c$1 = computed(() => a.disabled);
  y({ el: e2, $el: e2 });
  let f2 = computed(() => {
    var p2;
    return o2.virtual.value ? o2.activeOptionIndex.value === o2.calculateIndex(a.value) : o2.activeOptionIndex.value === null ? false : ((p2 = o2.options.value[o2.activeOptionIndex.value]) == null ? void 0 : p2.id) === u$12;
  ...
  onMounted(() => o2.registerOption(u$12, d2)), onUnmounted(() => o2.unregisterOption(u$12, f2.value)), watchEffect(() => {
    let p2 = o$1(e2);
    ...
    o2.comboboxState.value === 0 && f2.value && (o2.virtual.value || o2.activationTrigger.value !== 0 && nextTick(() => {
      var p2, R;
      return (R = (p2 = o$1(e2)) == null ? void 0 : p2.scrollIntoView) == null ? void 0 : R.call(p2, { block: "nearest" });
    }));
  });
  function D(p2) {
    p2.preventDefault(), p2.button === g.Left && (c$1.value || (o2.selectOption(u$12), n$2() || requestAnimationFrame(() => {
      var R;
  ...
  return () => {
    let { disabled: p2 } = a, R = { active: f2.value, selected: S.value, disabled: p2 }, V = { id: u$12, ref: e2, role: "option", tabIndex: p2 === true ? void 0 : -1, "aria-disabled": p2 === true ? true : void 0, "aria-selected": S.value, disabled: void 0, onMousedown: D, onFocus: E2, onPointerenter: M, onMouseenter: M, onPointermove: $2, onMousemove: $2, onPointerleave: B, onMouseleave: B }, i2 = T$1(a, ["order", "value"]);
    return A$2({ ourProps: V, theirProps: i2, slot: R, attrs: r, slots: h2, name: "ComboboxOption" });
  };
} });
function pe(o2, b) {
  return o2 === b;
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o2, { slots: b, attrs: r, emit: w$2$1 }) {
  let n2 = ref(1), e$1 = ref(null), f$2 = ref(null), v = ref(null), s2 = ref([]), m = ref(""), p2 = ref(null), a = ref(1);
  ...
  let D = computed(() => o2.multiple ? 1 : 0), [y, L] = d(computed(() => o2.modelValue), (t2) => w$2$1("update:modelValue", t2), computed(() => o2.defaultValue)), M = computed(() => y.value === void 0 ? u$5(D.value, { [1]: [], [0]: void 0 }) : y.value), k = { listboxState: n2, value: M, mode: D, compare(t2, i2) {
    ...
    return o2.by(t2, i2);
  }, orientation: computed(() => o2.horizontal ? "horizontal" : "vertical"), labelRef: e$1, buttonRef: f$2, optionsRef: v, disabled: computed(() => o2.disabled), options: s2, searchQuery: m, activeOptionIndex: p2, activationTrigger: a, closeListbox() {
    o2.disabled || n2.value !== 1 && (n2.value = 1, p2.value = null);
  }, openListbox() {
    o2.disabled || n2.value !== 0 && (n2.value = 0);
  }, goToOption(t2, i2, l2) {
    if (o2.disabled || n2.value === 1) return;
    let d2 = u2(), O2 = f(t2 === c.Specific ? { focus: c.Specific, id: i2 } : { focus: t2 }, { resolveItems: () => d2.options, resolveActiveIndex: () => d2.activeOptionIndex, resolveId: (h2) => h2.id, resolveDisabled: (h2) => h2.dataRef.disabled });
  ...
  w$2([f$2, v], (t2, i2) => {
    var l2;
    k.closeListbox(), w$4(i2, h.Loose) || (t2.preventDefault(), (l2 = o$1(f$2)) == null || l2.focus());
  }, computed(() => n2.value === 0)), provide($, k), t$2(computed(() => u$5(n2.value, { [0]: i$1.Open, [1]: i$1.Closed })));
  let C = computed(() => {
    var t2;
  ...
  return onMounted(() => {
    ...
    return h$1(Fragment, [...t2 != null && M.value != null ? e({ [t2]: M.value }).map(([I, Q]) => h$1(f$1, E$2({ features: u$3.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, disabled: l2, name: I, value: Q }))) : [], A$2({ ourProps: {}, theirProps: { ...r, ...T$1(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h$12, slots: b, attrs: r, name: "Listbox" })]);
  };
} });
defineComponent({ name: "ListboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(o2, { attrs: b, slots: r }) {
  ...
  function e2() {
    var v;
    (v = o$1(n2.buttonRef)) == null || v.focus({ preventScroll: true });
  }
  return () => {
    let v = { open: n2.listboxState.value === 0, disabled: n2.disabled.value }, { ...s2 } = o2, m = { id: w2, ref: n2.labelRef, onClick: e2 };
    return A$2({ ourProps: m, theirProps: s2, slot: v, attrs: b, slots: r, name: "ListboxLabel" });
  };
} });
let je = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o2, { attrs: b, slots: r, expose: w2 }) {
  ...
  return () => {
    var y, L;
    let a = { open: e2.listboxState.value === 0, disabled: e2.disabled.value, value: e2.value.value }, { ...u2 } = o2, D = { ref: e2.buttonRef, id: n2, type: m.value, "aria-haspopup": "listbox", "aria-controls": (y = o$1(e2.optionsRef)) == null ? void 0 : y.id, "aria-expanded": e2.listboxState.value === 0, "aria-labelledby": e2.labelRef.value ? [(L = o$1(e2.labelRef)) == null ? void 0 : L.id, n2].join(" ") : void 0, disabled: e2.disabled.value === true ? true : void 0, onKeydown: f2, onKeyup: v, onClick: s$12 };
    return A$2({ ourProps: D, theirProps: u2, slot: a, attrs: b, slots: r, name: "ListboxButton" });
  };
  ...
  function v(a) {
    switch (f2.value && clearTimeout(f2.value), a.key) {
      ...
      case o.Enter:
        ...
        break;
      case u$5(e2.orientation.value, { vertical: o.ArrowDown, horizontal: o.ArrowRight }):
        return a.preventDefault(), a.stopPropagation(), e2.goToOption(c.Next);
      case u$5(e2.orientation.value, { vertical: o.ArrowUp, horizontal: o.ArrowLeft }):
  ...
  return () => {
    var y, L;
    let a = { open: e2.listboxState.value === 0 }, { ...u2 } = o2, D = { "aria-activedescendant": e2.activeOptionIndex.value === null || (y = e2.options.value[e2.activeOptionIndex.value]) == null ? void 0 : y.id, "aria-multiselectable": e2.mode.value === 1 ? true : void 0, "aria-labelledby": (L = o$1(e2.buttonRef)) == null ? void 0 : L.id, "aria-orientation": e2.orientation.value, id: n2, onKeydown: v, role: "listbox", tabIndex: 0, ref: e2.optionsRef };
    return A$2({ ourProps: D, theirProps: u2, slot: a, attrs: b, slots: r, features: N$3.RenderStrategy | N$3.Static, visible: m.value, name: "ListboxOptions" });
  };
  ...
  return () => {
    ...
    return A$2({ ourProps: h2, theirProps: O2, slot: i2, attrs: r, slots: b, name: "ListboxOption" });
  };
} });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    let partners = ref([]);
    try {
      const { data } = ([__temp, __restore] = withAsyncContext(() => useGlobalCache("partners")), __temp = await __temp, __restore(), __temp);
      partners = data;
    } catch (error2) {
    }
    const form = ref({
    ...
    const partnerOptions = computed(
      () => {
        var _a;
        return ((_a = partners.value) == null ? void 0 : _a.map((p2) => ({ label: p2.name, value: p2.id }))) || [];
      }
    );
    const handleInvite = async () => {
      ...
      try {
        ...
        if (response.success) {
          ...
          error.value = ((_a = response.error) == null ? void 0 : _a.message) || "Failed to send invitation";
        }
      } catch (err) {
        if ((_c = (_b = err.data) == null ? void 0 : _b.error) == null ? void 0 : _c.message) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UFormGroup = __nuxt_component_4$1;
      ...
      _push(ssrRenderComponent(_component_UCard, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="text-xl font-semibold"${_scopeId}>Invite New User</h2>`);
          } else {
            return [
              createVNode("h2", { class: "text-xl font-semibold" }, "Invite New User")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(form).role === "staff") {
              _push2(ssrRenderComponent(_component_UFormGroup, {
                label: "Accessible Partners",
                name: "partner_ids"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_USelectMenu, {
                      modelValue: unref(form).partner_ids,
                      "onUpdate:modelValue": ($event) => unref(form).partner_ids = $event,
            ...
            if (unref(error)) {
              _push2(`<div class="bg-red-50 border border-red-200 rounded-lg p-3"${_scopeId}><p class="text-red-600 text-sm"${_scopeId}>${ssrInterpolate(unref(error))}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(success)) {
              _push2(`<div class="bg-green-50 border border-green-200 rounded-lg p-3"${_scopeId}><p class="text-green-600 text-sm"${_scopeId}>${ssrInterpolate(unref(success))}</p>`);
              if (unref(tempPassword)) {
                _push2(`<p class="text-green-700 font-mono text-xs mt-2"${_scopeId}> Temporary Password: ${ssrInterpolate(unref(tempPassword))}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            _push2(ssrRenderComponent(_component_UButton, {
              ...
              disabled: !unref(form).email || !unref(form).name || !unref(form).role,
              color: "primary"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Send Invitation `);
                } else {
                  return [
                    createTextVNode(" Send Invitation ")
                  ];
                }
              }),
              _: 1
            ...
            _push2(`</div><div class="mt-4 p-2 bg-gray-100 rounded text-xs"${_scopeId}><p${_scopeId}>Form data: ${ssrInterpolate(JSON.stringify(unref(form), null, 2))}</p><p${_scopeId}>Button disabled: ${ssrInterpolate(!unref(form).email || !unref(form).name || !unref(form).role)}</p></div></form>`);
          } else {
            return [
              createVNode("form", {
                onSubmit: withModifiers(handleInvite, ["prevent"]),
                class: "space-y-4"
              }, [
                ...
                unref(form).role === "staff" ? (openBlock(), createBlock(_component_UFormGroup, {
                  key: 0,
                  label: "Accessible Partners",
                  name: "partner_ids"
                }, {
                ...
                unref(error) ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("p", { class: "text-red-600 text-sm" }, toDisplayString(unref(error)), 1)
                ])) : createCommentVNode("", true),
                unref(success) ? (openBlock(), createBlock("div", {
                  key: 2,
                  class: "bg-green-50 border border-green-200 rounded-lg p-3"
                }, [
                  createVNode("p", { class: "text-green-600 text-sm" }, toDisplayString(unref(success)), 1),
                  unref(tempPassword) ? (openBlock(), createBlock("p", {
                    key: 0,
                    class: "text-green-700 font-mono text-xs mt-2"
                  }, " Temporary Password: " + toDisplayString(unref(tempPassword)), 1)) : createCommentVNode("", true)
                ])) : createCommentVNode("", true),
                ...
                createVNode("div", { class: "mt-4 p-2 bg-gray-100 rounded text-xs" }, [
                  createVNode("p", null, "Form data: " + toDisplayString(JSON.stringify(unref(form), null, 2)), 1),
                  createVNode("p", null, "Button disabled: " + toDisplayString(!unref(form).email || !unref(form).name || !unref(form).role), 1)
                ])
              ], 32)
            ];
          }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/users/invite.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=invite-4uixhVKc.mjs.map
